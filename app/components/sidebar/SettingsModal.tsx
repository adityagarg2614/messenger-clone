                        ...
                        <div className="mt-10 flex flex-col gap-y-8">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    ...
                                    >
                                        <div className="flex justify-center rounded-md px-3 py-2 text-sm font-semibold text-gray-900 border hover:bg-gray-50 transition focus-visible:outline-2 focus-visible:outline-indigo-600 focus-visible:outline-offset-2">
                                            Change
                                        </div>
                                    </CldUploadButton>
                                </div>
