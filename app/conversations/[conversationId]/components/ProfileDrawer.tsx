            ...
            <Transition.Root show={isOpen} as={Fragment}>
                <Dialog as='div' className="relative z-50" onClose={onClose}>
                    ...
                    <div className="fixed inset-0 overflow-hidden">
                        <div className="absoute inset-0 overflow-hidden">
                            <div className="pointer-events-none fixed inset-0 right-0 flex max-w-full pl-10 ">
                                <Transition.Child as={Fragment} enter="transform transition ease-in-out duration-500" enterFrom="transalate-x-full" enterTo="transalate-x-0" leave="transform transition ease-in-out duration-500" leaveTo="transalate-x-full">
                                    <Dialog.Panel className=" pointer-events-auto w-screen max-w-md">
                                        <div className="flex h-full flex-col overflow-scroll bg-white py-6 shadow-xl">
                                            <div className="px-4 sm:px-6">
                                                <div className="flex items-start justify-end">
                                                    <div className="ml-3 flex h-7 items-center">
                                                        <button onClick={onClose} type="button" className="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 transition cursor-pointer">
                                            ...
                                            <div className="relative px-4 flex-1 sm:px-6 mt-6 ">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                                                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                            ...
                                                            {data.isGroup && (
                                                                <div>
                                                                    <dt className="text-sm font-semibold text-gray-500 sm:w-40 sm:shrink-0">
                                                                        Members
                                                                    </dt>
                                                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">
                                                            ...
                                                            {!data.isGroup && (
                                                                <>
                                                                    <div>
                                                                        <dt className="text-sm font-medium text-gray-500 sm:shrink-0 sm:w-40">
                                                                            Joined
                                                                        </dt>
                                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">
